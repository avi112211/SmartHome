...
public class RtspHelper {
    ...
    private LibVLC mVlc;
    private static RtspHelper sInstance;
    private ByteBuffer mByteBuffer;
    private Context context;

    public static RtspHelper getInstance(Context context) {
        if (sInstance == null) {
            init(context);
        }
        return sInstance;
    ...
    private static void init(Context context) {
        if (sInstance == null) {
            ...
            sInstance = new RtspHelper(context);
        }
    }

    private RtspHelper(Context context) {
